...
export async function putCreateGame(game_name: string, name: string, number_of_tiles: number, number_of_guesses: number, scoring_method: string, banned_letters: string[]) {
